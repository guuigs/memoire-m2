# Bibliographie — Sources à vérifier et récupérer

Sources identifiées dans le M1. Statut à mettre à jour au fur et à mesure.

**Statuts possibles** : `[À RÉCUPÉRER]` / `[PDF OK]` / `[ACCÈS LIBRE]` / `[À VÉRIFIER]` / `[INTROUVABLE]`

---

## Sources académiques (articles, ouvrages)

### Ben Nasr, Hallem, De Carli (2018)
`[PDF OK]` — `ben-nasr-2018-apports-de-lapplication-mobile-aux-connaissances-et-a-levasion-mentale-induites-par-lexperience-museale-role-de-lattention-focalisee-et-de-la-distorsion-du-temps.pdf`
Ben Nasr, I., Hallem, Y., & De Carli, A. (2018). Apports de l'application mobile aux connaissances et à l'évasion mentale induites par l'expérience muséale : Rôle de l'attention focalisée et de la distorsion du temps. *Management & Avenir*, 99(1), 191–213.
- Lien proxy SPN : https://doi-org.ezproxy.univ-paris13.fr/10.3917/mav.099.0191
- Utilisé dans : M1 II.C (attention focalisée, évasion mentale)

### Ben Nasr, Hallem, Lagier (2017)
`[PDF OK]` — `ben-nasr-2017-quel-est-le-role-de-lapplication-mobile-dans-la-valorisation-de-lexperience-museale.pdf`
Ben Nasr, I., Hallem, Y., & Lagier, J. (2017). Quel est le rôle de l'application mobile dans la valorisation de l'expérience muséale ? *Management & Avenir*, 92(2), 87–108.
- DOI direct : https://doi.org/10.3917/mav.092.0087
- Lien proxy SPN : https://doi-org.ezproxy.univ-paris13.fr/10.3917/mav.092.0087
- Utilisé dans : M1 II.C (rôle de l'app mobile, visiteurs peu à l'aise avec le numérique)

### Blondeau, Meyer-Chemenska, Schmitt (2020)
`[ACCÈS LIBRE]`
Blondeau, V., Meyer-Chemenska, M., & Schmitt, D. (2020). Le design de l'expérience au musée : nouvelles perspectives de recherche. *Culture & Musées*, 35.
- URL : https://doi.org/10.4000/culturemusees.4637
- Utilisé dans : M1 bibliographie (non cité dans le corps du texte)

### Caillet (1995)
`[INTROUVABLE]`
Caillet, É. (1995). *À l'approche du musée : la médiation culturelle*. Presses Universitaires de Lyon.
- Google Books : https://books.google.fr/books?hl=fr&lr=&id=nJhYDwAAQBAJ
- Utilisé dans : M1 I.A, I.B (missions du musée, débats médiation)

### Deshayes (2004)
`[ACCÈS LIBRE]`
Deshayes, S. (2004). L'usage des supports mobiles au musée, des audioguides classiques au multimédia nomade. Communication présentée à ICHIM 04 - Digital Culture & Heritage / Patrimoine & Culture Numérique. Archives & Museum Informatics.
- Utilisé dans : M1 I.C (attentes du public, continuité avec outils précédents)
- **Note** : source de 2004, ancienne — à utiliser avec précaution en 2026

### Ducongé (2024)
`[ACCÈS LIBRE]`
Ducongé, G. (2024). L'audioguide de musées à l'ère post-COVID : un dispositif d'aide à la visite (toujours) incontournable ? [Mémoire].
- URL : https://www.academia.edu/download/118073409/DUCONGE_L_audioguide_de_mus...
- Utilisé dans : M1 bibliographie (non cité dans le corps du texte)
- **À explorer** : mémoire récent directement sur notre sujet

### Gentès & Jutant (2012)
`[ACCÈS LIBRE]`
Gentès, A., & Jutant, C. (2012). Nouveaux médias au musée : Le visiteur équipé. *Culture & Musées*, 19, 67–91.
- URL : https://doi.org/10.3406/pumus.2012.1648
- Utilisé dans : M1 bibliographie (non cité dans le corps du texte)

### Jarrier, Bourgeon-Renault, Belvaux (2019)
`[PDF OK]` — `jarrier-2019-une-mesure-des-effets-de-lutilisation-dun-outil-numerique-sur-lexperience-de-visite-museale.pdf`
Jarrier, E., Bourgeon-Renault, D., & Belvaux, B. (2019). Une mesure des effets de l'utilisation d'un outil numérique sur l'expérience de visite muséale. *Management & Avenir*, 108(2), 107–126.
- Lien proxy SPN : https://doi-org.ezproxy.univ-paris13.fr/10.3917/mav.108.0107
- Utilisé dans : M1 I.C (jeune public, borne multimédia, public habitué)

### Jarrier & Bourgeon-Renault (2020)
`[PDF OK]` — `jarrier-2020-lenrichissement-de-lexperience-de-visite-museale-par-lutilisation-doutils-interactifs-de-mediation.pdf`
Jarrier, E., & Bourgeon-Renault, D. (2020). L'enrichissement de l'expérience de visite muséale par l'utilisation d'outils interactifs de médiation. *Décisions Marketing*, 97(1), 87–101.
- URL : https://doi.org/10.7193/DM.097.87.101
- Utilisé dans : M1 bibliographie (non cité dans le corps du texte)

### Pérez Castellanos (coord.) (2016) — anciennement "Jannen Contreras Vargas et al."
`[PDF OK]` — `ESTUDIOS_SOBRE_PUBLICOS_Y_MUSEOS_PUBLICO.pdf` (303 p., hispanophone)
Pérez Castellanos, L. (coord.). (2016). *Estudios sobre públicos y museos. Volumen I. Públicos y museos: ¿Qué hemos aprendido ?* Escuela Nacional de Conservación, Restauración y Museografía (ENCRyM-INAH).
- **⚠️ Correction** : la référence du M1 attribuait la source à "Jannen Contreras Vargas et al." — le vrai coordinateur est **Leticia Pérez Castellanos**. À corriger dans le M2.
- **Chapitre utile identifié** : Chapitre 5 — Narváez Naranjo, M. « Audioguías y dispositivos móviles, su uso en los museos », pp. 138-161. C'est ce chapitre qui documente l'histoire de l'audioguide (Stedelijk Museum 1952).
- À citer sous la forme : Narváez Naranjo, M. (2016). « Audioguías y dispositivos móviles... » In Pérez Castellanos (coord.), *Estudios sobre públicos y museos*, ENCRyM-INAH, pp. 138-161.
- Utilisé dans : M1 II.B (histoire de l'audioguide, Stedelijk Museum 1952)
- **Fiche produite** : fiche 23 dans `06-bibliographie/fiches/`

### Schmitt (2014)
`[ACCÈS LIBRE]`
Schmitt, D. (2014). Vers une remédiation muséale à partir de l'expérience située des visiteurs. *Les Enjeux de l'information et de la communication*.
- URL : https://hal.science/hal-01550561v1/document
- Utilisé dans : M1 bibliographie (non cité dans le corps du texte)
...
### GECE (2024)
`[PDF OK]` — `Barometre-2024-des-publics-des-musees-et-des-lieux-patrimoniaux-Institut-Gece.pdf`
GECE. (2024). *Baromètre 2024 des publics des musées et des lieux patrimoniaux*. Agence GECE.
- Source centrale du M1, citée de nombreuses fois

### Institut d'études Gece-Test (2025)
`[PDF OK]` — `Barometre-pratiques-culturelles-2025_version-longue-MAJ_compressed.pdf`
Institut d'études Gece-Test. (2025). *Baromètre 2025 des publics des musées et des lieux patrimoniaux* (3e édition). Gece-Test.
- **Correction de nommage** : le fichier `Barometre-pratiques-culturelles-2025_...` est en réalité le Baromètre musées Gece-Test 3e édition (2025), pas le Baromètre des pratiques culturelles du Ministère de la Culture.
- **Fiche produite** : fiche 21 dans `06-bibliographie/fiches/`
- Utilisé pour : données de contexte outils de médiation 2025 (audioguide 75%, app 50%, statu quo numérique 62%)


### Nova, N. (2020)
`[PDF OK]` — `2020-Nova-Smartphone.pdf`
Nova, N. (2020). *Smartphones : Une enquête anthropologique*. Genève : HES-SO / HEAD.
- **Nouvelle source** — déposée le 2026-05-01
- Piste de réflexion pour : [RÉF À TROUVER : études sur la non-linéarité comme critère de qualité UX dans les apps mobiles] et compétition attentionnelle
- Fiche de lecture à produire

### Knight Foundation (2020)
`[ACCÈS LIBRE]`
Knight Foundation. (2020). *Digital Readiness and Innovation in Museums Report*.
- URL : https://knightfoundation.org/wp-content/uploads/2020/10/Digital-Readiness-and-Innovation-in-Museums-Report.pdf
- **Attention** : source identifiée via Perplexity AI dans le M1 — à vérifier données citées (49% musées américains avec app mobile en 2012)

---

## Sources orales et médias

### Jonchery (2024)
`[SOURCE ORALE]`
Jonchery, A. (2024). Introduction à la médiation et aux publics. Cours à l'École du Louvre, communication orale.
- Source non récupérable. À citer comme communication orale avec précaution.
- Utilisé dans : M1 I.C (visiteur se sous-estime, études des publics)

### France Culture (2021)
`[ACCÈS LIBRE]`
France Culture. (2021). Podcast « Histoire de musées ».
- URL : https://www.radiofrance.fr/franceculture/podcasts/serie-histoire-de-musees
- Utilisé dans : M1 I.A (historique de la médiation)

---

## Alertes qualité (sources à contrôler en priorité)

Sources identifiées via Perplexity AI dans le M1 — existence et données à vérifier avant tout usage dans le M2 :

- **Jannen Contreras Vargas et al. (2016)** : source hispanophone, difficile à vérifier
- **Knight Foundation (2020)** : données sur 2012 (49% musées US) — vérifier que le rapport existe et que le chiffre est exact
- **Caillet (1995)** : ouvrage existant mais citation de Guedj (1992) obtenue via Caillet — vérifier le passage exact

---

## Sources à trouver pour le M2 (besoins identifiés)

Ces sources ne sont pas dans le M1 mais seront utiles pour les parties nouvelles :

- [RÉF À TROUVER : données sur les taux d'usage réels des apps audioguide en France (abandons, téléchargements)]
	- Accès libre : https://journals.openedition.org/ocim/396?lang=en
- [RÉF À TROUVER : études sur la compétition attentionnelle du smartphone en contexte de visite]
	- Accès libre : https://theconversation.com/ce-que-nos-smartphones-font-au-musee-244545
- [RÉF À TROUVER : travaux sur la chaîne de production du contenu muséal (rôle du conservateur)]

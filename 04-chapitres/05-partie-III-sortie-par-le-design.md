...
**HC1 — Privilégier l'audio sur le visuel.** L'écran est une source de friction et de compétition attentionnelle. Un audioguide devrait être **audio-first** : le contenu principal est audio, l'écran ne sert qu'à naviguer, et cette navigation est minimale. L'idéal est que le visiteur puisse garder son téléphone dans sa poche pendant l'écoute.
...
Ces quatre hypothèses de conception seront testées dans le prototype présenté en III.2.

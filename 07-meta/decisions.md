# Décisions structurelles — Mémoire M2

Ce fichier consigne les décisions importantes prises au fil des sessions. Il sert de trace pour éviter les retours en arrière non assumés.
...
|---|---|---|
| Option de mémoire | Option B : mémoire applicatif avec prototype minimal testé sur 3-5 personnes (pas de mémoire purement analytique) | ✅ Actée |
| Problématique | v1d retenue : *« Entre la promesse d'une médiation accessible et la réalité d'un outil marginalement adopté, qu'est-ce qui, dans la conception ou dans le contexte, empêche l'application mobile audioguide de tenir son rôle ? »* | ✅ Validée |
| Stratégie de rédaction | Reprendre le M1 le plus fidèlement possible + ajouter les Parties III, IV, V (~55 pages nouvelles) | ✅ Actée |

---

## Session 4 — 2026-05-01 (suite)

| Décision | Contenu | Statut |
|---|---|---|
| Plan v3 | Abandon du plan par étapes méthodologiques (v2) au profit d'un plan thématique par tensions (Plan C) : Partie I "L'outil contre lui-même" (hypothèses contextuelle + anti-design + conception) / Partie II "L'institution contre l'outil" (hypothèses économique + organisationnelle + dépossession) / Partie III "Y a-t-il une sortie par le design ?" | ✅ Actée |
| Convention méthodo | Le matériau empirique est présenté (contexte + méthodo) à sa première apparition dans le développement. Les occurrences suivantes vont directement aux faits, sans re-contextualiser. | ✅ Actée |
| Baromètre Ministère de la Culture | Source écartée — non pertinente pour le mémoire | ✅ Définitive |
...
| Décision | Contenu | Statut |
|---|---|---|
| Plan v2 | Restructuration conforme consignes DIMI (Estrella Rojas) : Intro → État de l'art (A+B = M1) → Problématique/Hypothèses/Méthode → Partie I Terrain → Partie II Corpus → Partie III Prototype → Conclusion | ✅ Actée |
| Placement Discussion & Recommandations | Intégré dans Partie III.4 + Conclusion (pas de section autonome) | ✅ Actée |
| Placement Méthodologie | Dans la section "Problématique, hypothèses et méthode" (pas dans l'intro) | ✅ Actée |
| Second entretien musée | Transcription perdue — résumé reconstruit accepté comme matériau. Limitations à signaler dans la section méthodo du mémoire. | ✅ Actée |
| Hypothèses de travail | 5 hypothèses formalisées : conception, économique, organisationnelle, contextuelle, anti-design | ✅ Actées |
| Problématique v1d | Validée définitivement par Ekko le 2026-05-01 | ✅ Définitive |
